...
# This overrides both the hard-coded project VERSION (16.0) and the
# CPackProperties.cmake generated by FindVersion, whose `git describe` cannot
# see the real tag inside the detached source tarball used by platform jobs
# (it previously resolved to the wrong tag, e.g. jrpm-0.1.0 instead of the
# released jrpm-0.1.3). Apply it after include(CPack) so it wins over the
# generated CPackProperties include.
