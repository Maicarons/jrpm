...
public:
	static inline const SaveLoad description[] = {
		...
		SLE_CONDVAR(Vehicle, current_order.decouple_flags, VarTypes::U8, SaveLoadVersion::MinVersion, SaveLoadVersion::MaxVersion),
...
public:
	static inline const SaveLoad description[] = {
		 ...
		 SLE_CONDVAR(Train, decouple_part, VarTypes::U8, SaveLoadVersion::MinVersion, SaveLoadVersion::MaxVersion),
	};
...
public:
	static inline const SaveLoad description[] = {
		 SLEG_STRUCT("common", SlVehicleCommon),
		 SLE_CONDVAR(Aircraft, trackdir,              VarTypes::U8,                    SaveLoadVersion::CustomSubsidyDuration, SaveLoadVersion::MaxVersion),
		 SLE_CONDVAR(Aircraft, state,                 VarTypes::U8,                    SaveLoadVersion::CustomSubsidyDuration, SaveLoadVersion::MaxVersion),
		 SLE_CONDVAR(Aircraft, next_trackdir,         VarTypes::U8,                    SaveLoadVersion::CustomSubsidyDuration, SaveLoadVersion::MaxVersion),
		 SLE_CONDVAR(Aircraft, next_pos.x,            VarTypes::U32,                   SaveLoadVersion::CustomSubsidyDuration, SaveLoadVersion::MaxVersion),
		 SLE_CONDVAR(Aircraft, next_pos.y,            VarTypes::U32,                   SaveLoadVersion::CustomSubsidyDuration, SaveLoadVersion::MaxVersion),
		 SLE_CONDVAR(Aircraft, next_pos.pos,          VarTypes::U8,                    SaveLoadVersion::CustomSubsidyDuration, SaveLoadVersion::MaxVersion),
		     SLE_VAR(Aircraft, crashed_counter,       VarTypes::U16),
		SLEG_CONDVAR("aircraft_pos", _pos,            VarTypes::U8,                    SaveLoadVersion::MinVersion, SaveLoadVersion::CustomSubsidyDuration),
		...
		SLEG_CONDVAR("old_state", _old_state,         VarTypes::U8,                    SaveLoadVersion::MinVersion, SaveLoadVersion::CustomSubsidyDuration),
		SLEG_CONDVAR("previous_pos", _pos,            VarTypes::U8,                    SaveLoadVersion::VehicleCurrencyStationChanges, SaveLoadVersion::CustomSubsidyDuration),
	   ...
	   SLE_CONDRING(Aircraft, path.td,                VarTypes::U8,                    SaveLoadVersion::CustomSubsidyDuration, SaveLoadVersion::MaxVersion),
	   SLE_CONDRING(Aircraft, path.tile,              VarTypes::U32,                   SaveLoadVersion::CustomSubsidyDuration, SaveLoadVersion::MaxVersion),
	};
