...
public:
    ...
    static ObjectTileHighlight make_numbered_rect(SpriteID palette, uint32_t number);
...
public:
    ...
    DiagDirection ddir = DiagDirection::Invalid;
...
public:
    ...
    static ObjectHighlight make_industry(TileIndex tile, IndustryType ind_type, uint32_t ind_layout);
